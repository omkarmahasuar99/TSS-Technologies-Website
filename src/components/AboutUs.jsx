  ...
  const cards = [
    {
      id: 1,
      title: 'Our Story',
      description: 'We use the power of technology to deliver mission critical digital products that move the world. Our journey began with a simple idea: to create innovative solutions that make a difference.',
      imageUrl: ourStoryImage
    },
    {
      id: 2,
      title: 'Our Approach',
      description: 'We believe in a customer-centric approach, focusing on understanding the unique needs and goals of each customer.',
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 p-4 gap-4">
          ...
          <div className="bg-img bg-opacity-100 p-2 ">
            ...
            <p className="text-white">We specialize in imagining, building, and implementing technologies that empower our customers to stay continuously informed and agile in their operations</p>
          </div>
          ...
          <div className="bg-img bg-opacity-100 p-2">
            ...
            <p className="text-white ">Every day, across the globe, our dedicated team engineers impactful solutions-for our customers, communities, colleagues, and in our personal lives</p>
          </div>

          {/* Card 4 */}
          <div className="bg-img bg-opacity-100 p-2">
            <h2 className="text-white text-xl font-bold mb-2">How we behave</h2>
            <p className="text-white">We honor and respect each person's unique voice and background, recognizing that diversity not only enriches our culture but also drives our success</p>
          </div>
        </div>
