  ...
  return (
    <>
      ...
      <div className="bg-black-100 py-10">
        <div className="container mx-auto px-4 md:px-8 lg:px-28 py-8 ">
          <section className="mb-12">
            ...
            >
              ...
              testing and data science. We are dedicated to
              <span
                className={`additional-content ${isExpanded ? "expanded" : ""}`}
              >
                delivering high-quality, tailored solutions to meet the diverse
                needs of our clients. Our unwavering commitment to excellence
                and customer satisfaction fuels our every endeavor, ensuring
                that we deliver nothing but the best. At tsstechnologies, we
                strive to be more than just a technology provider. We aim to be
                your trusted partner on the journey to success in the digital
                world. At tsstechnologies, we believe in the transformative
                power of technology to effect positive change. We are committed
                to continuous exploration and innovation, ensuring that our
                solutions remain at the forefront of the digital landscape. Join
                us on our mission to revolutionize industries and enhance lives
                through exceptional digital advancements.
              </span>
            </p>
            <button
          ...
          <div
            className=" flex-col items-center justify-center text-center text-white bg-cover bg-center p-8 px-4 rounded-lg"
            style={{ backgroundImage: `url(${Image})` }}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 p-4 gap-4">
              {/* Card 1 */}
              <div className="bg-img bg-opacity-100 p-0 px-0 ">
              ...
              {/* Card 2 */}
              <div className="bg-img bg-opacity-100 p-4 px-0">
                <h2 className="text-white text-xl font-bold mb-2">
                  What we believe
                </h2>
                <p className="text-white">
